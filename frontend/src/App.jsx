...
// Add this import statement with your other page/component imports
import AIGeneratorPage from "./AIGeneratorPage/AIGeneratorPage.jsx"; // Adjust path if it's not in src
function App() {
